  ...
  return (
    <section className="py-20 lg:py-32 bg-background">
      <div className="container mx-auto px-4">
        ...
        >
          <p className="text-foreground/50 text-lg mb-2">Ne vjerujte nama,</p>
          <h2 className="text-4xl lg:text-5xl font-bold text-foreground">
            vjerujte našim klijentima
          </h2>
        </div>
        ...
        <div
          ref={logosRef}
          className={`flex flex-wrap justify-center items-center gap-8 lg:gap-16 mb-16 transition-all duration-700 delay-200 ${
            logosVisible
              ? "opacity-100 translate-y-0"
              : "opacity-0 translate-y-10"
          }`}
