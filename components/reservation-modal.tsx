        ...
        <DialogContent className="sm:max-w-md bg-card border-border">
          <div className="flex flex-col items-center justify-center py-8 text-center">
            ...
            <DialogDescription className="text-foreground/60 mb-6">
              Hvala vam na interesovanju. Kontaktiraćemo vas uskoro sa potvrdom rezervacije.
            </DialogDescription>
              ...
              <div className="flex flex-col items-center">
                ...
                <span
                  className={`text-xs mt-2 transition-colors ${
                    step >= indicator.number ? "text-primary" : "text-foreground/40"
                  }`}
                >
                  {indicator.label}
                </span>
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  id="pickup"
                  placeholder="npr. Aerodrom Nikola Tesla"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  id="dropoff"
                  placeholder="npr. Hotel Hilton, Beograd"
