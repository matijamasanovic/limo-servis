        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-foreground/60 text-lg max-w-2xl">
              Imate pitanje ili sugestiju? Kontaktirajte nas popunjavanjem forme
              ili putem jednog od brojeva telefona.
            </p>
          </div>
            ...
            >
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <a
                    href="viber://chat?number=%2B381691705023"
                    className="w-12 h-12 rounded-full border border-foreground/20 flex items-center justify-center hover:border-primary/50 transition-colors group"
                  >
                    <svg
                      viewBox="0 0 24 24"
                ...
                <div className="flex items-center gap-4 group">
                  ...
                  <span className="text-foreground/80">+381691705023</span>
                </div>

                {/* Email */}
                <a
                  href="mailto:office@htdtransfers.com"
                  className="flex items-center gap-4 group"
                >
                  <div className="w-12 h-12 rounded-full border border-foreground/20 flex items-center justify-center group-hover:border-primary/50 transition-colors">
                ...
                <div className="flex items-center gap-3 pt-4">
                  <a
                    href="#"
                    className="w-12 h-12 rounded-full border border-foreground/20 flex items-center justify-center hover:border-primary/50 hover:bg-primary/10 transition-all group"
                  >
                    <svg
                      viewBox="0 0 24 24"
                      className="w-6 h-6 text-foreground/70 group-hover:text-primary transition-colors"
