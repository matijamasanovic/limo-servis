      ...
      <div ref={sectionRef} className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-foreground/60 leading-relaxed">
            Imate specifične zahteve? Navedite ih tokom rezervacije, a mi ćemo
            se potruditi da vam izađemo u susret formiranjem jedinstvene ponude.
          </p>
        </div>
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-4 relative">
            {/* Step 1 */}
            <div
              className={`flex flex-col items-center md:items-start md:mt-32 transition-all duration-700 ${
                sectionVisible
                  ? "opacity-100 translate-y-0"
            ...
            {/* Step 2 */}
            <div
              className={`flex flex-col items-center md:mt-16 transition-all duration-700 ${
                sectionVisible
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-12"
              }`}
            ...
            {/* Step 3 */}
            <div
              className={`flex flex-col items-center md:items-end transition-all duration-700 ${
                sectionVisible
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-12"
              }`}
        ...
        >
          <p className="text-foreground/60 mb-6">
            Spremni za putovanje sa stilom?
          </p>
          <Button
            size="lg"
