...
const vehicles = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1563720360172-67b8f3dce741?w=1200&h=600&fit=crop",
    passengers: 3,
    luggage: 3,
    classType: "VIP klasa",
  ...
  {
    name: "Opel Vivaro",
    description: "Odličan izbor za udobno grupno putovanje ili transfer do aerodroma",
    image: "https://images.unsplash.com/photo-1559416523-140ddc3d238c?w=1200&h=600&fit=crop",
    passengers: 8,
    luggage: 8,
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1609521263047-f8f205293f24?w=1200&h=600&fit=crop",
    passengers: 7,
    luggage: 7,
    classType: "VIP klasa",
    classColor: "bg-primary"
        ...
        <div>
          ...
          <div className="flex items-center gap-4 mt-4">
            <div className="flex items-center gap-2 bg-white/20 backdrop-blur-sm rounded-lg px-3 py-1.5">
              ...
              <span className="text-white text-sm font-medium">{vehicle.passengers}</span>
            </div>
            <div className="flex items-center gap-2 bg-white/20 backdrop-blur-sm rounded-lg px-3 py-1.5">
              <Briefcase className="w-4 h-4 text-white" />
              <span className="text-white text-sm font-medium">{vehicle.luggage}</span>
            </div>
          </div>
          
          {/* Class Badge */}
          <div className="mt-4">
            <span className={`${vehicle.classColor} text-white text-xs font-semibold px-3 py-1.5 rounded-full`}>
              {vehicle.classType}
            </span>
          </div>
        </div>
    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="pt-28 md:pt-32 pb-20 px-4">
        <div className="container mx-auto max-w-5xl">
          ...
          <div 
            ref={headerRef}
            className={`mb-12 transition-all duration-700 ${headerVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
          >
